...
// Проверенная карта ключей полей коллекции «Гости (RSVP)».
const TITLE = "_8";  // «Имя» — контент-проперти, у item'а кладётся ВЕРХНИМ полем
const F = {
  token:     "_2",   // text          — токен приглашения (денормализован для поиска)
