...
export default function Hero() {
  return (
      <section className={"rGeu6w"} id="PBbM6hRVrsx6MjPz" data-scroll-ready="true" data-eid="hero/0" style={elStyle(layout["hero/0"])}>
        <div>
          <div className={styles.onhyOQ} data-eid="hero/1" style={elStyle(layout["hero/1"])}>
            <div className={styles.twbtjQ}>
              <div className={styles.GDnEHQ} data-eid="hero/2" style={elStyle(layout["hero/2"])}>
                <div className={styles.o2Yl2g}>
                  <div className={styles._mXnjA} lang="en" data-eid="hero/3" style={elStyle(layout["hero/3"])}>
                      ...
                      <div className={styles.a26Xuw}>
                        ...
                        <div className={styles.PcHy7w}>
                          <div className={cx(styles.uk_25A, styles.Ty61NA)}>
                            <div className={styles.Izwocg} data-eid="hero/5" style={elStyle(layout["hero/5"])}>
                    ...
                    <div className={cx(styles.DF_utQ, styles._682gpw, styles._0xkaeQ)} data-eid="hero/7" style={elStyle(layout["hero/7"])}>
                    ...
                    <div className={cx(styles.DF_utQ, styles._682gpw, styles._0xkaeQ)} data-eid="hero/10" style={elStyle(layout["hero/10"])}>
                        ...
                        <div className={styles.hWv4NA} data-eid="hero/12" style={elStyle(layout["hero/12"])}>
                          ...
                          <div className={styles.bFnJ2A} data-eid="hero/13" style={elStyle(layout["hero/13"])}>
                            <div className={cx(styles._4c2rDg, styles.GxUsfw)} data-eid="hero/14" style={elStyle(layout["hero/14"])}>
                              <div className={styles.qhHTGg} data-eid="hero/15" style={elStyle(layout["hero/15"])}>
                    ...
                    <div data-eid="hero/16" style={elStyle(layout["hero/16"])}>
                      <div className={cx(styles.DF_utQ, styles._682gpw, styles._0xkaeQ)} data-eid="hero/17" style={elStyle(layout["hero/17"])}>
                    ...
                    <div className={cx(styles.DF_utQ, styles._682gpw, styles._0xkaeQ)} data-eid="hero/21" style={elStyle(layout["hero/21"])}>
                          ...
                          <div className={styles.E8yZTA}>
                            <div>
                              <div className={cx(styles._2UyCZQ, styles.vkN2Cw, styles.Mb8E_A, styles.e1_zQg)} lang="en">
                                <p className={cx(styles._28USrA, styles.AfeL7g, styles.XN6uKA, styles._4N4NA)} data-eid="hero/24" style={elStyle(layout["hero/24"])}>
                    ...
                    <div className={cx(styles.DF_utQ, styles._682gpw, styles._0xkaeQ)} data-eid="hero/27" style={elStyle(layout["hero/27"])}>
                      <div className={cx(styles.aF9o6Q, styles._0yZ6Qg)} data-eid="hero/28" style={elStyle(layout["hero/28"])}>
                        <div data-eid="hero/29" style={elStyle(layout["hero/29"])}>
                          <div className={styles.E8yZTA}>
                            <div>
                              <div className={cx(styles._2UyCZQ, styles.vkN2Cw, styles.Mb8E_A, styles.e1_zQg)} lang="en">
                                <p className={cx(styles._28USrA, styles.AfeL7g, styles.XN6uKA, styles._4N4NA)} data-eid="hero/30" style={elStyle(layout["hero/30"])}>
                    ...
                    <div data-eid="hero/32" style={elStyle(layout["hero/32"])}>
                      <div className={cx(styles.DF_utQ, styles._682gpw, styles._0xkaeQ)} data-eid="hero/33" style={elStyle(layout["hero/33"])}>
              ...
              <div className={cx(styles.QhExXw, styles.pKfnlA)} data-eid="hero/37" style={elStyle(layout["hero/37"])} />
            </div>
          </div>
        </div>
      </section>
