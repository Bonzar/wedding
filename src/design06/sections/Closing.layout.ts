...
export const layout: Record<string, El> = {
  ...
  "closing/engraving": { x: 1313.445248514515, y: 685.7377891917326, w: 634.018, h: 439.019, raw: { "touchAction": "pan-x pan-y pinch-zoom" } },
  ...
  "closing/bodyText": { x: 271.80211728635436, y: 74.46145513803683, w: 1232.4, h: 378.8, raw: { "touchAction": "pan-x pan-y pinch-zoom" } },
  ...
  "closing/title": { x: 848.3273634969324, y: 608.9659351993865, w: 872.538, h: 281.38, rot: 8.88178e-16, raw: { "touchAction": "pan-x pan-y pinch-zoom" } },
