...
export const layout: Record<string, El> = {
  ...
  "closing/engraving": { x: 1103.7343274660398, y: 649.8581985583095, w: 634.018, h: 439.019, raw: { "touchAction": "pan-x pan-y pinch-zoom" } },
  ...
  "closing/bodyText": { x: 368.99197476115205, y: 74.46145513803683, w: 1232.4, h: 378.8, raw: { "touchAction": "pan-x pan-y pinch-zoom" } },
  "closing/text-1": { w: 1062.7489307775652, h: 378.8, raw: { "writingMode": "horizontal-tb" } },
  "closing/box-3": { x: 0, y: -5.6 },
  "closing/bodyTextParagraph": { font: "\"Jost\", system-ui, sans-serif", fontSize: 56, letterSpacing: "0em", lineHeight: "78px", textTransform: "none", color: "rgb(53, 80, 116)", raw: { "--gixK-A": "0", "--kJ5CrQ": "0", "--zPlnxA": "none", "listStyleType": "none", "whiteSpace": "normal" } },
  ...
  "closing/title": { x: 667.4687136801365, y: 608.9659351993865, w: 872.538, h: 281.38, rot: 8.88178e-16, raw: { "touchAction": "pan-x pan-y pinch-zoom" } },
  ...
  "closing/titleParagraph": { font: "\"Nicoletta Script SHA\", cursive", fontSize: 100, letterSpacing: "0em", lineHeight: "89px", textTransform: "none", color: "rgb(53, 80, 116)", raw: { "--gixK-A": "0", "--kJ5CrQ": "0", "--zPlnxA": "none", "listStyleType": "none" } },
